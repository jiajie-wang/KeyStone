      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          axios({
            ...
            //跳转功能
            this.$router.push({path: '/login',query:{uid: res.data, Email:this.form.email, phoneNum:this.form.phone, verifyQues:this.form.validatorQuestion, verifyAns:this.form.validatorAnswer}})
          }).catch(err => {
